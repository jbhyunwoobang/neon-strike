...
ledger + session-protocol source. Last updated: 2026-07-04 (F1 FIDELITY GATE: **GO** — procedural board-form + stillwood pass the one-frame test at 60fps; Engine.setGrade EV-anchor API born).*
